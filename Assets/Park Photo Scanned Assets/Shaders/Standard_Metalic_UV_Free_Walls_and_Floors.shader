Shader "NatureManufacture Shaders/Standard Metalic UV Walls and Floors"
{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_CBUFFER_START(NatureManufactureShadersStandardMetalicUVWallsandFloors)
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 _AlbedoColor_Instance = UNITY_ACCESS_INSTANCED_PROP(_AlbedoColor);
			...
			float4 _DirtAlbedoColor_Instance = UNITY_ACCESS_INSTANCED_PROP(_DirtAlbedoColor);
